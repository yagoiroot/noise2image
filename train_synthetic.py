...
parser.add_argument("--aug_contrast", action='store_true', help="Augment image contrast during synthetic training.")

num_photon_scalar = 0.9462
num_time = 22.7278
eps_pos = 0.6839
eps_neg = 0.7349
bias_pr = 1.6406
illum_offset = 0.2124
constant_noise_neg = 0.1128
